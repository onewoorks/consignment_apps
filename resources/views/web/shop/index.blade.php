                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="text-center p-4 border-end">
                            ...
                            <h5 class="text-truncate pb-1">Shop B</h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="text-center p-4 border-end">
                            ...
                            <h5 class="text-truncate pb-1">Shop C</h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="text-center p-4 border-end">
                            ...
                            <h5 class="text-truncate pb-1">Shop D</h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="text-center p-4 border-end">
                            ...
                            <h5 class="text-truncate pb-1">Shop E</h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="text-center p-4 border-end">
                            ...
                            <h5 class="text-truncate pb-1">Shop F</h5>
                        </div>
                    </div>
